...
DEFAULT_SETTINGS = {
    ...
    # Gabliteration
    "use_gabliteration": False,
    "gab_num_directions": 2,
    "gab_ridge_lambda": 0.1,
    "gab_layer_scaling_beta": 0.5,
    "gab_skip_first_layers": 2,
    "gab_skip_last_layers": 2,
    # J-lens (J-space) direction restriction
    "use_jlens_restriction": False,
    "jlens_vectors_path": None,
    "jlens_basis_rank": 16,
    "jlens_min_projection_ratio": 0.1,
    "jlens_num_prompts": 32,
    "jlens_batch_size": 2,
    "jlens_max_seq_len": 64,
    "jlens_grad_checkpoint": False,
    "jlens_concepts": None,
